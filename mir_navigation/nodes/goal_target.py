...
class map_navigation():
  ...
  def choose(self):
    ...
    rospy.loginfo("|'1': Goal_1: ( 19.0 , 10.0)")
    rospy.loginfo("|'2': Goal_2: (13.0 , 18.0) ")
...
##### Task: How to save the velocity data to the file? So that they can be analysed in the matlab. #######
